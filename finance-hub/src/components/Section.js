...
export const TABS = [
  ...
  { id: 'forex', label: 'Forex', icon: 'currency' },
  { id: 'crypto', label: 'Crypto', icon: 'crypto' },
  { id: 'stocks', label: 'Aktien', icon: 'chart' },
  { id: 'etfs', label: 'ETFs', icon: 'layers' },
  { id: 'commodities', label: 'Rohstoffe', icon: 'cube' },
];
 ...
 */
export function createTabNavigation(activeTab = 'all') {
  return `
    <div id="tabNavigation" class="mb-6 overflow-x-auto scrollbar-hide">
      <div class="flex gap-2 min-w-max pb-2">
        ${TABS.map(tab => `
          <button
            class="tab-btn px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 flex items-center gap-2 whitespace-nowrap
                   ${activeTab === tab.id
...
function getTabIcon(iconName) {
  const icons = {
    ...
    crypto: '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>',
    chart: '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>',
    layers: '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>',
